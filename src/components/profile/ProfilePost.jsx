...
const ProfilePost = ({ post, key }) => {
  ...
  if(post === null || post === undefined || userProfile === null || userProfile === undefined){
      ...
      >
        ...
        <ModalContent>
          ...
          <ModalBody bg={'black'} pb={5}>
            <Flex gap={4} w={{ base: '90%', sm: '70%', md: 'full' }} mx={'auto'} minH={'50vh'} maxH={'90vh'}>
              <Flex
                borderRadius={4}
                overflow={'hidden'}
                border={'1px solid'}
